...
public class ExpressionTree {
  ...
  public String infixToPostfix(String infixExpression) {
    ...
    StringTokenizer strTok = new StringTokenizer(infixExpression, " "); // The reference to a String Tokenizer delimited
                                                                        // by spaces.
    ...
    while (strTok.hasMoreTokens()) {
      ...
      // if operator
        ...
        while (!s.isEmpty() && (s.peek().toString().charAt(0) != '(')
            && (checkPrecedence(buffer.charAt(0)) <= checkPrecedence(s.peek().toString().charAt(0)))) {
  ...
  /**
   * Determines if the item in question is an operand to be used in infix to
   * postfix algorithm.
   * 
  ...
  /**
   * Checks the precedence of the operator to be used in infix to postfix
   * algorithm.
   * 
  ...
  public Node buildTree(String postfixExpression) {
    ...
    StringTokenizer strTok = new StringTokenizer(postfixExpression, " "); // The reference to a String Tokenizer
                                                                          // delimited by spaces.
    String buffer; // Buffer to hold tokens.
